...
function DashboardSidebar({
  ...
  return /* @__PURE__ */ jsxs2("aside", { className: cn(
    ...
    /* @__PURE__ */ jsx2("div", { className: "flex h-16 items-center border-b border-[var(--border)] px-5", children: brand }),
    /* @__PURE__ */ jsx2("nav", { className: "flex-1 space-y-1 px-3 py-4 overflow-y-auto", children }),
    footer && /* @__PURE__ */ jsx2("div", { className: "border-t border-[var(--border)] p-4", children: footer })
  ] });
}
...
function DashboardNavGroup({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: cn("space-y-1", className), children: [
    label && /* @__PURE__ */ jsx5("p", { className: "px-3 py-2 text-xs font-semibold uppercase tracking-wider text-[var(--foreground-subtle)]", children: label }),
    children
  ] });
}
